...
void main(){
	...
	vec3 MaterialDiffuseColor = texture(texture1, UV).rgb;//Color; //<----
    MaterialDiffuseColor = mix(MaterialDiffuseColor,BaseColor,0.2);
    ...
    vec3 comp1 = vec3(smoothstep(0.4, 1.0, vdn));
